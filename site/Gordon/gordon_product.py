...
for result in myresults:
    try:
        ...
        for spec in driver.find_elements(By.XPATH, '// *[ @ id = "spectable"] / table / tbody'): #spectable
            ...
            print(attr_lst2)
            print(value_lst2)
    # sql = "INSERT INTO gordon (title,breadcrumb,price,image,resources) VALUES (%s, %s,%s, %s,%s)"
    # val = (url, TITLE, breadcrumb,price, image, resources)
    # mycursor.executemany(sql, (val,))
    # mydb.commit()
    # print(mycursor.rowcount, "record inserted.")

    # for x,y in zip(attr_lst2,value_lst2):
    #     sql = "INSERT INTO gordon (attr_name, attr_value) VALUES (%s, %s)"
    #     val = (x,y)
    #     mycursor.executemany(sql, (val,))
    #     mydb.commit()
    #     print(mycursor.rowcount, "record inserted.")
