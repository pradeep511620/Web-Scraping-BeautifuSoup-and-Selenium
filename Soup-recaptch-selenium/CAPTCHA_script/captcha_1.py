...
for i in range(5):
    try:
        ...
        Res = requests.get('https://www.raptorsupplies.com/create',proxies=proxy)
...
'lastname': 'kumar',
'companyName': '',
'email': 'tajender@raptorsupplies.com',
...
for i in range(5):
    try:
        ...
        get_in_touch = requests.post('https://www.raptorsupplies.com/customer/account/createpost/',data=data,headers=h1,proxies=proxy)
