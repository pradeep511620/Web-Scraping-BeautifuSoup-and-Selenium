...
cur = mydb.cursor()
cur.execute("SELECT  new_attr_name,new_attr_value,model_no,entity_id,l3_name,id,value1 FROM `58_l3_update_new_value` where remarks_25='missing values' AND attr_data_type ='Continuous'  AND value1 LIKE '%/%' AND unit1 !=''  ")
