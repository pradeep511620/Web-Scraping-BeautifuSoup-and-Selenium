#applied.com/search?q=%3Arelevance%3Abrand%3ABrand-1288&page=0&override=true&isLevelUp=false
import urllib.parse
...
def get_details(url):
    ...
    save_details: TextIO = open("Applied.txt", "a+")
    ...
    try:
        for i in range(1,20):
            ...
            i=str(i)
            ele = driver.find_element_by_xpath("//*[@id='content']/div[1]/div[2]/div[3]/div[3]/div["+i+"]/div/div[2]/div/div[1]/h2/a").get_attribute("href")
            i=int(i)
            i=i+1
            ...
            try:
                ...
                pass
            save_details: TextIO = open("Applied.txt", "a+", encoding="utf-8")
...
if __name__ == '__main__':
    for x in range(0,200):
     x=str(x)
     url = "https://www.applied.com/search?q=%3Arelevance%3Abrand%3ABrand-1288&page="+x+"&override=true&isLevelUp=false"
     x=int(x)
     x=x+1
     get_details(url)
