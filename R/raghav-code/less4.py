...
def main():
    th_xpath = "./tr/text() | ./tr/text()"
    td_xpath = "./thead/tr/td/text() | ./tbody/tr/td/text()"

    for page in range(0, 206):
        r = requests.get(f"https://www.applied.com/search?q=%3Arelevance%3Abrand%3ABrand-1288&page={page}&override=true&isLevelUp=false")#https://www.mrosupply.com/brands/leeson/?page=1
        tree = html.fromstring(r.text)
        links = ["https://www.applied.com" + href for href in
                 tree.xpath("//div[@class='col-md-4 col-sm-3 product__image-wrapper']/a/@href")]  #//div[@class='product__image-wrapper']/a/@href
        wb, ws = load_excel()
        ...
        for link in links:
            ...
            tables = t.xpath("//table[@class='table table-striped table-striped--inverted table-stacked']")
