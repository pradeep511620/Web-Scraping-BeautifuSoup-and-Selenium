...
for fetch in url:
    ...
    if a == 1:
        ...
        time.sleep(2)
        print('l3 rfq successfully submit!')
        ...
        driver.find_element_by_xpath('//*[@id="shipping-form"]/div/div[3]/button').click()
        time.sleep(2)
        print('mother rfq submit successfully')
    elif a == 3:
        ...
        driver.find_element_by_xpath('//*[@id="shipping-form"]/div/div[3]/button').click()
        time.sleep(2)
        print("product rfq submitted successfully!")
    elif a == 4:
        ...
        driver.find_element_by_xpath('//*[@id="shipping-form"]/div/div[3]/button').click()
        time.sleep(2)
        print('raxit brand rfq submitted successfully! ')
    elif a == 5:
        ...
        driver.find_element_by_xpath('//*[@id="shipping-form"]/div/div[3]/button').click()
        time.sleep(2)
        print('dodge bearing rfq submitted successfully!')
